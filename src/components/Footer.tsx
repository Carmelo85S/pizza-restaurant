    ...
    <footer className="bg-gray-900 text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-serif font-bold">Bella<span className="text-pizza-500">Pizza</span></h3>
            <p className="mt-4 text-gray-400">
              Authentic Italian pizza made with love and tradition since 1982.
            </p>
          ...
          <div>
            ...
            <p className="mt-4 text-gray-400">(212) 555-1234</p>
            <p className="text-gray-400">info@bellapizza.com</p>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500">© 2025 BellaPizza. All rights reserved.</p>
